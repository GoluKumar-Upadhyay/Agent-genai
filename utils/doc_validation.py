...
vision_path = os.path.join(BASE_DIR, os.getenv("VISION_API_KEY"))
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = vision_path
vision_client = vision.ImageAnnotatorClient()

# Set Vertex AI credentials
vertex_path = os.path.join(BASE_DIR, os.getenv("VERTEX_AI_KEY"))
os.environ["VERTEX_AI_CREDENTIALS"] = vertex_path
llm = ChatVertexAI(model="gemini-2.5-flash", temperature=0)

print(os.environ["GOOGLE_APPLICATION_CREDENTIALS"])
print(os.environ["VERTEX_AI_CREDENTIALS"])
...
STUDENT_KEYWORDS = [
    ...
    "campus selection", "offer of admission", "counselling letter",
